...
[RegularExpression("^(ADMIN_ROLE|USER_ROLE)$", ErrorMessage = "El rol debe ser 'ADMIN_ROLE' o 'USER_ROLE'")]
public string RoleName { get; set; } = string.Empty; // "ADMIN_ROLE" o "USER_ROLE"
