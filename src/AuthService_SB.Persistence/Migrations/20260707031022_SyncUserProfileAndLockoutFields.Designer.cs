...
namespace AuthService_SB.Persistence.Migrations
{
    ...
    [Migration("20260707031022_SyncUserProfileAndLockoutFields")]
    partial class SyncUserProfileAndLockoutFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthService_SB.Domain.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("AuthService_SB.Domain.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
            ...
            modelBuilder.Entity("AuthService_SB.Domain.Entities.UserEmail", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
            ...
            modelBuilder.Entity("AuthService_SB.Domain.Entities.UserPasswordReset", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
            ...
            modelBuilder.Entity("AuthService_SB.Domain.Entities.UserProfile", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
            ...
            modelBuilder.Entity("AuthService_SB.Domain.Entities.UserRole", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
            ...
            modelBuilder.Entity("AuthService_SB.Domain.Entities.UserEmail", b =>
                {
                    b.HasOne("AuthService_SB.Domain.Entities.User", "User")
                        .WithOne("UserEmail")
                        .HasForeignKey("AuthService_SB.Domain.Entities.UserEmail", "UserId")
            ...
            modelBuilder.Entity("AuthService_SB.Domain.Entities.UserPasswordReset", b =>
                {
                    b.HasOne("AuthService_SB.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("AuthService_SB.Domain.Entities.UserPasswordReset", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("AuthService_SB.Domain.Entities.UserProfile", b =>
                {
                    b.HasOne("AuthService_SB.Domain.Entities.User", "User")
                        .WithOne("UserProfile")
                        .HasForeignKey("AuthService_SB.Domain.Entities.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("AuthService_SB.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("AuthService_SB.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
